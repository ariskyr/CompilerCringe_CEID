...
// %type <strval> program mainBlock functionDeclarations functionDeclaration parameterDeclarations parameter
// %type <strval> argumentList argument functionCall statements statement simpleStatement assignStatement
// %type <strval> printStatement nestedStatement whileStatement forStatement ifStatement elseifStatements
// %type <strval> switchStatement caseStatements caseStatement defaultStatement expression andExpression
// %type <strval> comparison addition multiplication negation power input type varType array variables
// %type <strval> variable varDeclaration
...
%start program /* den einai aparaitito to program einai o prwtos kanonas etsi kialliws */

%%

program: T_PROGRAM T_ID  functionDeclarations mainBlock                                                         
       | T_PROGRAM T_ID   mainBlock                                                                             
       ;
mainBlock: T_STARTMAIN                                                                                         
            statements T_ENDMAIN                                                                               
         ;
...
simpleStatement: assignStatement 
               | printStatement T_SEMIC
               | functionCall
               | varDeclaration T_SEMIC
               | T_BREAK T_SEMIC
               ;
...
whileStatement: T_WHILE T_LPAREN expression T_RPAREN statements T_ENDWHILE
              ;
forStatement: T_FOR assignStatement T_TO expression T_STEP expression
                    statements T_ENDFOR
            ;
...
varDeclaration: T_VARS varType variables
              ;
